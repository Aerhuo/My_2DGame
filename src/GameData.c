...
const CharacterConfig characterConfigs[] = {
    {"三角洲高手", '@', 100.0f, 10.0f, 2.5f, 0},
    {"早八", 'M', 80.0f, 5.0f, 1.0f, 6000},
    {"晚自习", 'E', 100.0f, 7.0f, 1.0f, 4000},
    {"周六早八", 'S', 120.0f, 5.0f, 1.0f, 2000},
    {"周日晚自习", 'N', 120.0f, 10.0f, 1.25f, 1000},
    {"体测", 'T', 220.0f, 20.0f, 1.5f, 500},
    {"考试", 'X', 200.0f, 25.0f, 2.25f, 200},
    {"挂科", 'F', 240.0f, 22.0f, 3.25f, 100},
    {"假期", 'H', 300.0f, 5.0f, 0.5f, 50},
    {"重修", 'B', 1000.0f, 40.0f, 10.5f, 30},
};
